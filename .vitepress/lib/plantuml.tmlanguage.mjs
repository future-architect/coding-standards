// Copied from https://github.com/qjebbs/vscode-plantuml/blob/7bc1758ed73dc269f5721d78c6c6c01f461d7cb0/syntaxes/plantuml.yaml-tmLanguage
const data = {
      ...
      patterns: [
        ...
        },
        {
          ...
          captures: {
            ...
            3: {
              name: "meta.comment.note.source.wsd",
            },
          },
        },
        {
        ...
        },
        {
          ...
          captures: {
            ...
            9: {
              name: "meta.comment.noteof.source.wsd",
            },
          },
        },
        {
        ...
        },
        {
          ...
          captures: {
            ...
            2: {
              name: "meta.comment.noteas.source.wsd",
            },
            3: {
              name: "keyword.other.noteas.source.wsd",
            },
          ...
          patterns: [
            ...
            },
            {
              ...
              captures: {
                ...
                2: {
                  name: "meta.comment.message.link.source.wsd",
                },
              },
            },
            {
      ...
      patterns: [
        {
          ...
          captures: {
            ...
            5: {
              name: "meta.comment.activity.if.source.wsd",
            },
          },
        },
        {
          ...
          captures: {
            ...
            3: {
              name: "meta.comment.activity.else.source.wsd",
            },
          },
        },
        {
          ...
          captures: {
            ...
            7: {
              name: "meta.comment.activity.while.source.wsd",
            },
          },
        },
        {
          ...
          captures: {
            ...
            4: {
              name: "meta.comment.activity.endwhile.source.wsd",
            },
          },
        },
      ],
      ...
      patterns: [
        ...
        },
        {
          ...
          captures: {
            ...
            2: {
              name: "meta.comment.sequence.delay.source.wsd",
            },
            3: {
              name: "keyword.operator.sequence.delay.source.wsd",
            },
      ...
      patterns: [
        {
          ...
          captures: {
            ...
            2: {
              name: "meta.comment.object.addfields.source.wsd",
            },
          },
        },
      ],
          ...
          patterns: [
            {
              ...
              captures: {
                1: {
                  name: "meta.comment.class.group.separator.source.wsd",
                },
                3: {
...
export const scopeName = data.scopeName;
export const fileTypes = data.fileTypes;
